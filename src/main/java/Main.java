...
public class Main {
    public static void main(String[] args) {
        ...
        patient p1 = new patient(1001, "Akshar Patel", LocalDate.of(2023, 5, 10), "Winnipeg", true, false);
        patient p2 = new patient(1002, "Vrujal Patel", LocalDate.of(1995, 7, 20), "Winnipeg", true, true);
        patient p3 = new patient(1003, "John", LocalDate.of(1980, 3, 2), "Winnipeg", false, false);
